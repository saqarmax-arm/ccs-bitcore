...
////////////////////////////////////////////////////////////// ccs
        ...
        globalState = std::unique_ptr<CcSState>(new CcSState(dev::u256(0), CcSState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
        dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::ccsTestNetwork)));
