#ifndef CCSVERSIONCHECKER_H
#define CCSVERSIONCHECKER_H

#include <QObject>

#define CCS_RELEASES "https://github.com/ccsproject/ccs/releases"
...
class CcSVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit CcSVersionChecker(QObject *parent = 0);
    ~CcSVersionChecker();
