...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    genesis.hashStateRoot = uint256(h256Touint(dev::h256("e965ffd002cd6ad0e2dc402b8044de833e06b23127ea8c3d80aec91410771495"))); // ccs
    genesis.hashUTXORoot = uint256(h256Touint(dev::sha3(dev::rlp("")))); // ccs
    return genesis;
}
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 985500; // ccs halving every 4 years
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000036a70ae675b98824c5"); // ccs
        ...
        vSeeds.push_back(CDNSSeedData("ccs3.dynu.net", "ccs3.dynu.net", false)); // CcS mainnet
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000d6e528bcf5a3a556f"); // ccs
        ...
        vSeeds.push_back(CDNSSeedData("ccs4.dynu.net", "ccs4.dynu.net", false)); // CcS testnet

        vSeeds.push_back(CDNSSeedData("ccs-testnet1.earlz.net", "ccs-testnet1.earlz.net", false)); // CcS testnet
...
public:
    CRegTestParams() {
        ...
        consensus.BIP34Height = 0; // BIP34 has not activated on regtest (far in the future so block v1 are not rejected in tests) // activate for ccs
