...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // ccs
        hashUTXORoot.SetNull(); // ccs
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //ccs
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //ccs
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //ccs
    {
